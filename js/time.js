function showTime() { 
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear LaoYan:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----nide宝贝son   2018-12-25</c>"; 
